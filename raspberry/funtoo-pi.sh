...
# you wish to install Funtoo for Raspberry Pi on. Make certain no partitions of
# the device you choose are mounted!!
blkidDev=$1
...
sleep 2; sudo rm -rf /mnt/pi; mkdir /mnt/pi && sleep 2; sudo mount ${blkidDev}3 /mnt/pi
sleep 2; sudo rm -rf /mnt/boot; mkdir /mnt/boot && sleep 2; sudo mount ${blkidDev}1 /mnt/boot
...
#Funtoo armv6j_hardfp
	...
	#then
		txzExtract "${owd}/stage3-latest-*.tar.xz" "/mnt/pi"
	#else
...
#		txzExtract "${owd}/stage3-latest-${utc}.tar.xz" "/mnt/pi"
	#fi
#Gentoo
	#cd "${owd}"
	...
	#tar xfpj stage3-armv6j_hardfp-*.tar.bz2 -C /mnt/pi/

#Install Portage
#Funtoo
#	cd /mnt/pi/usr
#	sudo git clone --depth 1 -b funtoo.org git://github.com/funtoo/ports-2012.git portage
#Gentoo
	#wget http://distfiles.gentoo.org/snapshots/portage-latest.tar.bz2 
	#tar xjf portage-latest.tar.bz2 -C /mnt/pi/usr
